...
// Used to store the iterations it took for a given complex number to either be
// included or not included in the mandelbrot set As well as some pointers to
// sum, product, and z complex numbers that need to be passed by reference to
// the various funcs in mandelbrot.c
